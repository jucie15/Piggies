...
class Profile(models.Model):
    ...
    image = models.ImageField(upload_to='%Y/%m/%d/profile/', default='cast/img/angry.png')
    ...
    birth = models.CharField(max_length=16, null=True, blank=True, verbose_name='생년월일', validators=[birth_validator]) # 생년월일
    city = models.CharField(max_length=16, null=True, blank=True, verbose_name='시/도') # 시/도
    district = models.CharField(max_length=8, null=True, blank=True, verbose_name='구') # 구
